...
{
    //[FilePath("Tiny Giant Studio/UserStats_global.asset", FilePathAttribute.Location.PreferencesFolder)]
    public class UserStats_Global : ScriptableSingleton<UserStats_Global>
    {
        ...
        public int TotalTimeSpentInDomainReload
        {
            get
            {
                return _totalTimeSpentInDomainReload;
            }
            set
            {
        ...
        public void LoadFromDisk()
        {
            ...
            if (File.Exists(path))
            {
                ...
                //Debug.Log("Loaded Global stats from " + path);
            }
            else
            {

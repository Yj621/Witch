...
namespace TinyGiantStudio.DevTools
{
    ...
    public abstract class Page
    {
        ...
        /// </summary>
        /// <param name="projectManagerWindow">Keep a reference to the main script to reference later.</param>
        /// <param name="container">The visual element which holds all the contents of the page.</param>
        public abstract void SetupPage(DevToolsWindow projectManagerWindow, VisualElement container);
        /// <summary>

...
namespace TinyGiantStudio.DevTools.DevTasks
{
    public class Page_Settings : TabPage
    {
        ...
        public override void SetupPage(DevToolsWindow newProjectManagerWindow, VisualElement container)
        {
            devToolsWindow = newProjectManagerWindow;
            content = container;
        ...
        /// </summary>
        private void FindAllSettingsContents()
        {

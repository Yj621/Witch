...
namespace TinyGiantStudio.DevTools.DevTrails
{
    public class UserStats_Global_UI
    {
        ...
        private Label global_averageCompileTime;
        ...
        public UserStats_Global_UI(VisualElement container)
        {
            ...
            global_averageCompileTime = container.Q<Label>("AverageCompileTime");
        ...
        internal void UpdateInfo()
        {
            ...
            if (userStats.CompileCounter == 0)
                global_averageCompileTime.text = "Not recorded";
            else
                global_averageCompileTime.text = SmallStringTime((int)userStats.TotalTimeSpentCompiling / userStats.CompileCounter);

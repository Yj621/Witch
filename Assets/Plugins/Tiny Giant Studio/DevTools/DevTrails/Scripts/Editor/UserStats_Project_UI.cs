...
namespace TinyGiantStudio.DevTools.DevTrails
{
    public class UserStats_Project_UI
    {
        ...
        private Label project_averageCompileTime;
        ...
        public UserStats_Project_UI(VisualElement container)
        {
            ...
            project_averageCompileTime = container.Q<Label>("AverageCompileTime");
        ...
        internal void UpdateInfo()
        {
            ...
            if (userStats.CompileCounter == 0)
                project_averageCompileTime.text = "Not recorded";
            else
                project_averageCompileTime.text = SmallStringTime((int)userStats.TotalTimeSpentCompiling / userStats.CompileCounter);

            compileTime.text = SmallStringTime(userStats.TotalTimeSpentCompiling);
            domainReloadTime.text = SmallStringTime(userStats.TotalTimeSpentInDomainReload);
